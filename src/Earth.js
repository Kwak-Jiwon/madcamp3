...
//  // 컴포넌트가 마운트될 때 사용자 총액을 가져옵니다.
//  useEffect(() => {
//   const fetchTotalMoney = async () => {
//     try {
//       const response = await axios.get(`http://43.200.215.241:2000/user-money?userid=${userId}`);
//       if (response.data.status === 'success') {
//         setTotalMoney(response.data.currentMoney);
//       } else {
//         console.error('Error fetching total money:', response.data.message);
//       }
//     } catch (error) {
